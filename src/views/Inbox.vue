                ...
                <div class="chat_ib">
                  <h5>{{ inbox.id }}
                    <span class="chat_date">
                      ...
                      <img
                        src="https://firebasestorage.googleapis.com/v0/b/fantasea-4140a.appspot.com/o/app_media%2Fgarbage2.png?alt=media&token=83b0d802-f360-414c-a8b4-dfc2af72df34"
                        alt="delete" class="remove-message-icon" v-show="isEdit" @click.prevent="deleteThis(inbox.id)">
                    </span>
                  </h5>
                </div>
              </div>
        ...
        <div class="mesgs" v-show="isOpenConvo">
          <div class="msg_history">
            <div v-for="message in messages" :key="message.key"
              :class="(message.username == username ? 'outgoing_msg' : 'incoming_msg')">
              <div :class="(message.username == username ? 'sent_msg' : 'received_withd_msg')">
                ...
                <span class="time_date"> {{ message.time_sent }} | {{ message.date_sent }}</span>
              </div>
            </div>
          </div>
          <div class="type_msg">
            <div class="input_msg_write">
              ...
              <button class="msg_send_btn" type="button" @click.prevent="sendMessage"><i class="fa fa-paper-plane-o"
